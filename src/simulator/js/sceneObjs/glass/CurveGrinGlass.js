 ...
 * @memberof sceneObjs
 * @property {Array<Array<Point>>} points - The points which represent each curved lens in the modular lens
 ...
 * @property {Array<Object>} lensData - Properties pertaining to each lens in a composite lens
 ...
 * @property {number} stepSize - The step size for the ray trajectory equation. (default: 1)
 * @property {number} intersectTol - Tolerance for intersection calculations in pixels
 * @property {number} curLens - Index of the lens most recently (or currently being) drawn.
 */
